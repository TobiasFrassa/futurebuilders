...
button.addEventListener("click", () => {
  ...
  var happiness = document.getElementById(happiness_select);
  var minus = document.getElementById(minus_select);
  var plus = document.getElementById(plus_select);
  var schulart = document.getElementById(schulart_select);
  var klasse = document.getElementById(klasse_select);
  ...
  localStorage.setItem("happiness-übergabe", happiness);
  localStorage.setItem("minus-übergabe", minus);
  localStorage.setItem("plus-übergabe", plus);
  localStorage.setItem("schulart-übergabe", schulart);
  localStorage.setItem("klasse-übergabe", klasse);

window.location.assign("js/ergebnis/schüler_abgeschlosseneausbildung_ergebnis.html");
